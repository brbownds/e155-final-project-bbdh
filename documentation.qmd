...
![Figure 6a: The python simulation matches the hardware FFT output values in simulation for the same ideal cosine wave input.](fft_control_tb.png){width=800}

![Figure 6b: The simulation shows the testbench display comparing all 512 outputs of the python output to the hardware FFT output within ~1% of error.](expected_vs_got.png){width=800}
...
![Figure 7: The LCD screen can accurately display note name, pitch, and offset from the MCU LUT.](440.png){width=600} 
